...
const SignUp = () => {
  return (
    <div className='signup-container bg-white h-screen'>
        ...
        <input id='phone-input' maxLength={1} type="text" className="custom-input block p-3 mr-1 mb-6 w-10 text-sm text-gray-900 rounded-full  border-1 border-gray-300 active:border-gray-300"  />
        <input id='phone-input' maxLength={1} type="text" className="custom-input block p-3 mr-1 mb-6 w-10 text-sm text-gray-900 rounded-full  border-1 border-gray-300 active:border-gray-300"  />
        <input id='phone-input' maxLength={1} type="text" className="custom-input block p-3 mr-1 mb-6 w-10 text-sm text-gray-900 rounded-full  border-1 border-gray-300 active:border-gray-300"  />
        <input id='phone-input' maxLength={1} type="text" className="custom-input block p-3 mr-1 mb-6 w-10 text-sm text-gray-900 rounded-full  border-1 border-gray-300 active:border-gray-300"  />
        <input id='phone-input' maxLength={1} type="text" className="custom-input block p-3 mr-1 mb-6 w-10 text-sm text-gray-900 rounded-full  border-1 border-gray-300 active:border-gray-300"  />
    ...
    <Link to='/landingpage' className='flex items-center justify-center w-60 h-14 my-2.5 rounded-full border-white text-white bg-mainTheme'>
