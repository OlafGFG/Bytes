...
const LandingPage = () => {
  return (
    <div className="signup-container flex-col items-center justify-center w-mwidth border-x-2 bg-white">
        <div className='landing-page-header flex w-width  items-center mx-auto justify-around'>
        ...
        <input placeholder= 'Search "Cold Coffee"' className="focus:outline-none block pl-4 h-10 w-width  mb-6 mt-2 mx-auto text-sm text-gray-900 placeholder-gray-600  bg-searchbar rounded-full focus:border-red-200"></input>
