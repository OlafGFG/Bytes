...
import { Link } from "react-router-dom"
  ...
  return (
    <div className='signup-container flex-col items-center justify-center w-mwidth border-x-2 bg-white'>
        ...
        <input placeholder= 'Search "Cold Coffee"' className="focus:outline-none block pl-5 h-10 w-80  mb-6 mt-2 text-sm text-gray-900 placeholder-gray-500  bg-searchbar rounded-full focus:border-red-200"></input>
