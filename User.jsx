  ...
  return (
    <div className='signup-container'>
        ...
        <div className='whoareyoubuttons flex flex-col items-center mt-4 mb-32'>
            ...
            <button type='submit' className = 'mb-8'><img src = {Student}></img></button>

            <button type='submit' className = 'mb-8'><img src = {Teacher}></img></button>

            <button type='submit' className = 'mb-8'><img src = {Staff}></img></button>
